...
public abstract class Shape { // Declaring the shape abstract class

	// Declaring the abstract method with parameter List & datatype
	abstract void RectangleArea(float height, float width);

	abstract void SquareArea(float side);

	abstract void CircleArea(float radius);

} // end of the abstract class Shape
